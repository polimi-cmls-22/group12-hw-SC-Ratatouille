...
SynthDef(\alg1, {
	...
	var op1 = SinOsc.ar(freq1 + op2, 0, index1 + ampMod) * EnvGen.kr(env1, gate, doneAction: 2);
...
SynthDef(\alg3, {
	...
	var op3 = SinOsc.ar(freq3, 0, freq3*index3) * EnvGen.kr(env3, gate, doneAction: 2);
	var op2 = SinOsc.ar(freq2 + op3, 0, freq2*index2) * EnvGen.kr(env2, gate, doneAction: 2);
	var op1 = SinOsc.ar(freq1 + op2 + op4, 0, index1 + ampMod) * EnvGen.kr(env1, gate, doneAction: 2);
...
SynthDef(\alg4, {
	...
	var op1 = SinOsc.ar(freq1 + op2 + op3, 0, index1 + ampMod) * EnvGen.kr(env1, gate, doneAction: 2);
...
SynthDef(\alg5, {
	...
	var op4 = SinOsc.ar(freq4, 0, freq4*index4) * EnvGen.kr(env4, gate, doneAction: 2);
	var op3 = SinOsc.ar(freq3 + op4, 0, index3 + (ampMod/2)) * EnvGen.kr(env3, gate, doneAction: 2);
	var op2 = SinOsc.ar(freq2, 0, freq2*index2) * EnvGen.kr(env2, gate, doneAction: 2);
	var op1 = SinOsc.ar(freq1 + op2, 0, index1 + (ampMod/2)) * EnvGen.kr(env1, gate, doneAction: 2);
...
SynthDef(\alg6, {
	...
	var op4 = SinOsc.ar(freq4, 0, freq4*index4) * EnvGen.kr(env4, gate, doneAction: 2);
	var op3 = SinOsc.ar(freq3 + op4, 0, index3 + (ampMod/3)) * EnvGen.kr(env3, gate, doneAction: 2);
	var op2 = SinOsc.ar(freq2 + op4, 0, index2 + (ampMod/3)) * EnvGen.kr(env2, gate, doneAction: 2);
	var op1 = SinOsc.ar(freq1 + op4, 0, index1 + (ampMod/3)) * EnvGen.kr(env1, gate, doneAction: 2);
...
SynthDef(\alg7, {
	...
	var op4 = SinOsc.ar(freq4, 0, freq4*index4) * EnvGen.kr(env4, gate, doneAction: 2);
	var op3 = SinOsc.ar(freq3 + op4, 0, index3 + (ampMod/3)) * EnvGen.kr(env3, gate, doneAction: 2);
	var op2 = SinOsc.ar(freq2, 0, index2 + (ampMod/3)) * EnvGen.kr(env2, gate, doneAction: 2);
	var op1 = SinOsc.ar(freq1, 0, index1 + (ampMod/3)) * EnvGen.kr(env1, gate, doneAction: 2);
...
SynthDef(\alg8, {
	...
	var op4 = SinOsc.ar(freq4, 0, index4 + (ampMod/4)) * EnvGen.kr(env4, gate, doneAction: 2);
	var op3 = SinOsc.ar(freq3, 0, index3 + (ampMod/4)) * EnvGen.kr(env3, gate, doneAction: 2);
	var op2 = SinOsc.ar(freq2, 0, index2 + (ampMod/4)) * EnvGen.kr(env2, gate, doneAction: 2);
	var op1 = SinOsc.ar(freq1, 0, index1 + (ampMod/4)) * EnvGen.kr(env1, gate, doneAction: 2);
